...
{%- if execute -%}
    {%- if dbtvault.is_something(columns) and dbtvault.is_something(values) -%}
        {{ exceptions.raise_compiler_error("Invalid call to hash macro. Expected one of columns or values to be provided,
        but received both.") }}
    {%- endif -%}
{%- endif %}
